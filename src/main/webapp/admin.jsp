        ...
        <nav class="navbar-default navbar-side" role="navigation" style="background-image: url(images/368326.jpg);">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="messages.jsp"><i class="fa fa-desktop"></i> List of messages</a>
                    </li>
					<li>
                        <a class="active-menu" href="admin.jsp"><i class="fa fa-bar-chart-o"></i>List of reservations </a>
                    </li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<tr>
                                            ...
                                            <td><% out.println(c.getDateDebut()); %></td>
                                            <td><% out.println(c.getDateFin()); %></td>
                                            <td><image width=60 heigth=60 class=img-fluid src="<%=c.getImage()%>" /></td>
              
                                            <td><% out.println(c.getNumero()); %></td>
                                             <td><% out.println(c.getPrix()); %></td>
                                             <%
	if(c.getReserved() != 1){
	
%>
                                              <td><form action="ApproveController" method="POST">
                                              <input type="hidden" class=img-fluid name="id" value="<%=c.getId()%>" />
                                              
					<button type="submit" class=" btn btn-success"><i class="fas fa-sign-out-alt"></i>Approve</button>
					</form></td>     
					<%
	}
	else {
